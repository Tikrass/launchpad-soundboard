...
def tick(extra=None):
    ...
    try:
        ...
        #Main thread probably closed the stream on exit, we exit too then
        print "Mixing thread exiting"
        thread.exit()
